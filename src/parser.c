...
enum {
  ...
  anon_sym_QMARK_COLON = 105,
  anon_sym_EQ = 106,
  anon_sym_IS = 107,
  anon_sym_BANG_EQ = 108,
  anon_sym_ISNOT = 109,
  anon_sym_EQ_EQ = 110,
  anon_sym_QMARK_EQ = 111,
  anon_sym_STAR_EQ = 112,
  anon_sym_TILDE = 113,
  anon_sym_BANG_TILDE = 114,
  anon_sym_QMARK_TILDE = 115,
  anon_sym_STAR_TILDE = 116,
  anon_sym_LT = 117,
  anon_sym_LT_EQ = 118,
  anon_sym_GT = 119,
  anon_sym_GT_EQ = 120,
  ...
  anon_sym_SLASH = 125,
  anon_sym_ = 126,
  anon_sym_STAR_STAR = 127,
  anon_sym_IN = 128,
  anon_sym_CONTAINS = 129,
  anon_sym_2 = 130,
  anon_sym_CONTAINSNOT = 131,
  anon_sym_3 = 132,
  anon_sym_CONTAINSALL = 133,
  anon_sym_4 = 134,
  anon_sym_CONTAINSANY = 135,
  anon_sym_5 = 136,
  anon_sym_CONTAINSNONE = 137,
  anon_sym_6 = 138,
  anon_sym_INSIDE = 139,
  anon_sym_7 = 140,
  anon_sym_NOTINSIDE = 141,
  anon_sym_NOTIN = 142,
  anon_sym_8 = 143,
  anon_sym_ALLINSIDE = 144,
  anon_sym_9 = 145,
  anon_sym_ANYINSIDE = 146,
  anon_sym_10 = 147,
  anon_sym_NONEINSIDE = 148,
  anon_sym_11 = 149,
  anon_sym_OUTSIDE = 150,
  anon_sym_INTERSECTS = 151,
  anon_sym_LPAREN = 152,
  anon_sym_RPAREN = 153,
  anon_sym_LBRACK = 154,
  anon_sym_RBRACK = 155,
  ...
  anon_sym_array = 164,
  anon_sym_bool = 165,
  anon_sym_datetime = 166,
  anon_sym_decimal = 167,
  anon_sym_duration = 168,
  anon_sym_float = 169,
  anon_sym_int = 170,
  anon_sym_number = 171,
  anon_sym_object = 172,
  ...
  anon_sym_RS384 = 187,
  anon_sym_RS512 = 188,
  aux_sym_function_token1 = 189,
  aux_sym_function_token2 = 190,
  anon_sym_count = 191,
  aux_sym_function_token3 = 192,
  aux_sym_function_token4 = 193,
  aux_sym_function_token5 = 194,
  aux_sym_function_token6 = 195,
  aux_sym_function_token7 = 196,
  aux_sym_function_token8 = 197,
  aux_sym_function_token9 = 198,
  aux_sym_function_token10 = 199,
  aux_sym_function_token11 = 200,
  aux_sym_function_token12 = 201,
  aux_sym_function_token13 = 202,
  aux_sym_function_token14 = 203,
  aux_sym_function_token15 = 204,
  aux_sym_function_token16 = 205,
  anon_sym_true = 206,
  anon_sym_false = 207,
  anon_sym_TRUE = 208,
  anon_sym_FALSE = 209,
  ...
  sym_comment = 215,
  anon_sym_SQUOTE = 216,
  aux_sym_string_token1 = 217,
  anon_sym_BSLASH = 218,
  aux_sym_string_token2 = 219,
  anon_sym_DQUOTE = 220,
  aux_sym_string_token3 = 221,
  sym_source_file = 222,
  sym_token = 223,
  sym_scripting_function = 224,
  sym_scripting_content = 225,
  sym__scripting_statement = 226,
  sym_future = 227,
  sym_casting = 228,
  sym_property = 229,
  sym_identifier = 230,
  ...
  aux_sym_scripting_content_repeat1 = 247,
  ...
  switch (state) {
    case 0:
      ...
      if (('J' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('e' <= lookahead && lookahead <= 'z')) ADVANCE(576);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(2);
    ...
    case 100:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          ('_' <= lookahead && lookahead <= 'z')) ADVANCE(595);
      END_STATE();
    case 101:
      ACCEPT_TOKEN(aux_sym_property_token1);
