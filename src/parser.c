...
enum {
  ...
  aux_sym_operator_token1 = 114,
  anon_sym_AMP_AMP = 115,
  anon_sym_AND = 116,
  anon_sym_PIPE_PIPE = 117,
  anon_sym_OR = 118,
  anon_sym_QMARK_QMARK = 119,
  anon_sym_QMARK_COLON = 120,
  anon_sym_EQ = 121,
  anon_sym_IS = 122,
  ...
  anon_sym_TILDE = 128,
  anon_sym_BANG_TILDE = 129,
  anon_sym_QMARK_TILDE = 130,
  anon_sym_STAR_TILDE = 131,
  anon_sym_LT = 132,
  anon_sym_LT_EQ = 133,
  anon_sym_GT = 134,
  anon_sym_GT_EQ = 135,
  ...
  anon_sym_IN = 143,
  anon_sym_CONTAINS = 144,
  anon_sym_2 = 145,
  anon_sym_CONTAINSNOT = 146,
  anon_sym_3 = 147,
  anon_sym_CONTAINSALL = 148,
  anon_sym_4 = 149,
  anon_sym_CONTAINSANY = 150,
  anon_sym_5 = 151,
  anon_sym_CONTAINSNONE = 152,
  anon_sym_6 = 153,
  anon_sym_INSIDE = 154,
  anon_sym_7 = 155,
  anon_sym_NOTINSIDE = 156,
  anon_sym_NOTIN = 157,
  anon_sym_8 = 158,
  anon_sym_ALLINSIDE = 159,
  anon_sym_9 = 160,
  anon_sym_ANYINSIDE = 161,
  anon_sym_10 = 162,
  anon_sym_NONEINSIDE = 163,
  anon_sym_11 = 164,
  anon_sym_OUTSIDE = 165,
  anon_sym_INTERSECTS = 166,
  anon_sym_LPAREN = 167,
  anon_sym_RPAREN = 168,
  anon_sym_LBRACK = 169,
  anon_sym_RBRACK = 170,
  anon_sym_LBRACE = 171,
  anon_sym_RBRACE = 172,
  anon_sym_DASH_GT = 173,
  anon_sym_LT_DASH = 174,
  anon_sym_COMMA = 175,
  anon_sym_SEMI = 176,
  anon_sym_COLON = 177,
  aux_sym_function_token1 = 178,
  aux_sym_function_token2 = 179,
  aux_sym_function_token3 = 180,
  anon_sym_count = 181,
  aux_sym_function_token4 = 182,
  aux_sym_function_token5 = 183,
  aux_sym_function_token6 = 184,
  aux_sym_function_token7 = 185,
  aux_sym_function_token8 = 186,
  aux_sym_function_token9 = 187,
  aux_sym_function_token10 = 188,
  aux_sym_function_token11 = 189,
  aux_sym_function_token12 = 190,
  aux_sym_function_token13 = 191,
  aux_sym_function_token14 = 192,
  aux_sym_function_token15 = 193,
  aux_sym_function_token16 = 194,
  aux_sym_function_token17 = 195,
  anon_sym_any = 196,
  anon_sym_array = 197,
  anon_sym_bool = 198,
  anon_sym_datetime = 199,
  anon_sym_decimal = 200,
  anon_sym_duration = 201,
  anon_sym_float = 202,
  anon_sym_int = 203,
  anon_sym_number = 204,
  anon_sym_object = 205,
  ...
  anon_sym_BSLASH = 235,
  aux_sym_string_token2 = 236,
  anon_sym_DQUOTE = 237,
  aux_sym_string_token3 = 238,
  sym_source_file = 239,
  sym_token = 240,
  sym_scripting_function = 241,
  sym_scripting_content = 242,
  sym__scripting_statement = 243,
  sym_future = 244,
  sym_casting = 245,
  sym_property = 246,
  sym_identifier = 247,
  ...
  aux_sym_scripting_content_repeat1 = 264,
  aux_sym_string_repeat1 = 265,
  aux_sym_string_repeat2 = 266,
};
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 247) ADVANCE(779);
      if (lookahead == 8712) ADVANCE(793);
      if (lookahead == 8713) ADVANCE(796);
      if (lookahead == 8715) ADVANCE(783);
      if (lookahead == 8716) ADVANCE(785);
      if (lookahead == 8834) ADVANCE(800);
      if (lookahead == 8835) ADVANCE(789);
      if (lookahead == 8836) ADVANCE(802);
      if (lookahead == 8837) ADVANCE(791);
      if (lookahead == 8838) ADVANCE(798);
      if (lookahead == 8839) ADVANCE(787);
      if (lookahead == '\t' ||
          lookahead == '\n' ||
          lookahead == '\r' ||
          lookahead == ' ') SKIP(0)
      ...
      if (('J' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('e' <= lookahead && lookahead <= 'z')) ADVANCE(628);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(2);
    ...
    case 115:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          ('_' <= lookahead && lookahead <= 'z')) ADVANCE(647);
      END_STATE();
    case 116:
      ACCEPT_TOKEN(aux_sym_property_token1);
