...
enum {
  ...
  anon_sym_OR = 105,
  anon_sym_QMARK_QMARK = 106,
  anon_sym_QMARK_COLON = 107,
  anon_sym_EQ = 108,
  anon_sym_IS = 109,
  anon_sym_BANG_EQ = 110,
  anon_sym_ISNOT = 111,
  anon_sym_EQ_EQ = 112,
  anon_sym_QMARK_EQ = 113,
  anon_sym_STAR_EQ = 114,
  anon_sym_TILDE = 115,
  anon_sym_BANG_TILDE = 116,
  anon_sym_QMARK_TILDE = 117,
  anon_sym_STAR_TILDE = 118,
  anon_sym_LT = 119,
  anon_sym_LT_EQ = 120,
  anon_sym_GT = 121,
  anon_sym_GT_EQ = 122,
  ...
  anon_sym_SLASH = 127,
  anon_sym_ = 128,
  anon_sym_STAR_STAR = 129,
  anon_sym_IN = 130,
  anon_sym_CONTAINS = 131,
  anon_sym_2 = 132,
  anon_sym_CONTAINSNOT = 133,
  anon_sym_3 = 134,
  anon_sym_CONTAINSALL = 135,
  anon_sym_4 = 136,
  anon_sym_CONTAINSANY = 137,
  anon_sym_5 = 138,
  anon_sym_CONTAINSNONE = 139,
  anon_sym_6 = 140,
  anon_sym_INSIDE = 141,
  anon_sym_7 = 142,
  anon_sym_NOTINSIDE = 143,
  anon_sym_NOTIN = 144,
  anon_sym_8 = 145,
  anon_sym_ALLINSIDE = 146,
  anon_sym_9 = 147,
  anon_sym_ANYINSIDE = 148,
  anon_sym_10 = 149,
  anon_sym_NONEINSIDE = 150,
  anon_sym_11 = 151,
  anon_sym_OUTSIDE = 152,
  anon_sym_INTERSECTS = 153,
  anon_sym_LPAREN = 154,
  anon_sym_RPAREN = 155,
  anon_sym_LBRACK = 156,
  anon_sym_RBRACK = 157,
  ...
  anon_sym_array = 166,
  anon_sym_bool = 167,
  anon_sym_datetime = 168,
  anon_sym_decimal = 169,
  anon_sym_duration = 170,
  anon_sym_float = 171,
  anon_sym_int = 172,
  anon_sym_number = 173,
  anon_sym_object = 174,
  ...
  anon_sym_RS384 = 190,
  anon_sym_RS512 = 191,
  aux_sym_function_token1 = 192,
  aux_sym_function_token2 = 193,
  anon_sym_count = 194,
  aux_sym_function_token3 = 195,
  aux_sym_function_token4 = 196,
  aux_sym_function_token5 = 197,
  aux_sym_function_token6 = 198,
  aux_sym_function_token7 = 199,
  aux_sym_function_token8 = 200,
  aux_sym_function_token9 = 201,
  aux_sym_function_token10 = 202,
  aux_sym_function_token11 = 203,
  aux_sym_function_token12 = 204,
  aux_sym_function_token13 = 205,
  aux_sym_function_token14 = 206,
  aux_sym_function_token15 = 207,
  aux_sym_function_token16 = 208,
  anon_sym_true = 209,
  anon_sym_false = 210,
  anon_sym_TRUE = 211,
  anon_sym_FALSE = 212,
  ...
  sym_comment = 218,
  anon_sym_SQUOTE = 219,
  aux_sym_string_token1 = 220,
  anon_sym_BSLASH = 221,
  aux_sym_string_token2 = 222,
  anon_sym_DQUOTE = 223,
  aux_sym_string_token3 = 224,
  sym_source_file = 225,
  sym_token = 226,
  sym_scripting_function = 227,
  sym_scripting_content = 228,
  sym__scripting_statement = 229,
  sym_future = 230,
  sym_casting = 231,
  sym_property = 232,
  sym_identifier = 233,
  ...
  aux_sym_scripting_content_repeat1 = 250,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (lookahead == 247) ADVANCE(716);
      if (lookahead == 8712) ADVANCE(730);
      if (lookahead == 8713) ADVANCE(733);
      if (lookahead == 8715) ADVANCE(720);
      if (lookahead == 8716) ADVANCE(722);
      if (lookahead == 8834) ADVANCE(737);
      if (lookahead == 8835) ADVANCE(726);
      if (lookahead == 8836) ADVANCE(739);
      if (lookahead == 8837) ADVANCE(728);
      if (lookahead == 8838) ADVANCE(735);
      if (lookahead == 8839) ADVANCE(724);
      if (lookahead == '\t' ||
          lookahead == '\n' ||
          lookahead == '\r' ||
          lookahead == ' ') SKIP(0)
      ...
      if (('J' <= lookahead && lookahead <= 'Z') ||
          lookahead == '_' ||
          ('e' <= lookahead && lookahead <= 'z')) ADVANCE(578);
      END_STATE();
    case 1:
      if (lookahead == '\n') ADVANCE(2);
    ...
    case 100:
      ...
      if (('0' <= lookahead && lookahead <= '9') ||
          ('A' <= lookahead && lookahead <= 'Z') ||
          ('_' <= lookahead && lookahead <= 'z')) ADVANCE(597);
      END_STATE();
    case 101:
      ACCEPT_TOKEN(aux_sym_property_token1);
